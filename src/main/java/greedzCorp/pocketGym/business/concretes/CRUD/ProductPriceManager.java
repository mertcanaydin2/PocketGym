...
public class ProductPriceManager implements ProductPriceService {
    ...
    public ProductPriceManager(ProductPriceDao productPriceDao, ModelMapperService modelMapperService) {
    ...
    public DataResult<List<ProductPriceResponse>> findByProductIdAndPriceAndIsActv(ProductPriceRequest request) {
        List<ProductPriceEntity> result = this.productPriceDao.findByProductIdAndPriceAndIsActv(request.getProductId(), request.getPrice(), 1);
    ...
    public Result add(ProductPriceRequest request) {
        ...
        this.productPriceDao.save(productPriceEntity);
    ...
    public Result delete(Long id) {
        this.productPriceDao.deleteById(Math.toIntExact(id));
